...
namespace DataAccess
{
    public class ExEventAccessor
    {
        public static List<ManagerExEvent> SelectManagerEvents(string dept)
        {
            ...
            var query = "SELECT event_id, ex_event.employee_id, employee.department_name, employee.employee_id, event_date, submission_date, activity_name, start_time, end_time, status_name, activity_note FROM ex_event, employee WHERE ex_event.employee_id = employee.employee_id AND employee.department_name = 'Inbound' AND status_name = 'Pending'";
